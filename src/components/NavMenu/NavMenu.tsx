    ...
    <>
      ...
      <S.MenuMobile>
        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4.6875 5.625H25.3125V7.5H4.6875V5.625Z" fill="#333333" />
          <path d="M4.6875 14.0625H25.3125V15.9375H4.6875V14.0625Z" fill="#333333" />
          <path d="M4.6875 22.5H25.3125V24.375H4.6875V22.5Z" fill="#333333" />
        </svg>
